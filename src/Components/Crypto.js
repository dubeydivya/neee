        ...
        <motion.div className='container-fluid crypto ' initial={{ width: 0 }} animate={{ width: "100%" }} exit={{ x: window.innerWidth, transition: { duration: 0.1 } }}>
            <div className="row crypto-row">
                <div className='col-md-12 text-white text-center p-4 '>
                    <Zoom>
                        <div className='display-5 p-3'>CRYPTO MINING SERVICES</div>
                    ...
                    <Zoom>
                        <div className='text-paragrap pt-5'>
                            <p className='text-white title'>HEYRAM INFRASTRUCTURE's strong and dependable wallet system protects your digital
                                valuables.</p>
                            <p className='text-white title'>provides a range of flexible payment options to meet your individual budgetary needs.
